...
import Printer_Img from '../../Images/printer_image.png'
    ...
    return (
      <div className="Navbar-body">
        ...
        <section className="Navbar-right">
          {/* search bar */}
          <Icon_Button imageSorce={Search_Img} linkHandler="/user-dash" />
          {/* pantry gallary */}
          <Icon_Button imageSorce={Pantry_Img} linkHandler="/user-pantry" />
          {/* recipe gallary */}
          <Icon_Button
            imageSorce={Recipe_Img}
            linkHandler="/user-recipe-card"
          />
          {/* shopping list */}
          <Icon_Button
            imageSorce={Shopping_Img}
            linkHandler="/user-shopping-list"
          />
          {/* shopping list */}
          <Icon_Button
            imageSorce={Printer_Img}
            linkHandler="/ingredients/print"
          />
          {/* ? */}
